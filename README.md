...
|  Model(s)                        | Series       | RS232 Gen1 | RS232 Gen2 | IP | Notes |
|  ------------------------------- | ------------ | -------- | -------- | -- | ----- |
|  Statement D2, D2v, D2v 3D       | ANTHEM_D2    | X |   |   |
|  Statement D1                    | ANTHEM_D1    | X |   |   |
|  AVM 20                          | ANTHEM_AVM20 | X |   |   | unknown
|  AVM 30                          | ANTHEM_AVM30 | X |   |   | unknown
|  AVM 50, AVM 50v                 | ANTHEM_AVM50 | X |   |   | unknown
|  MRX 300, MRX 500, MRX 700       | ANTHEM_MRX   | X |   |   | unknown if supported
